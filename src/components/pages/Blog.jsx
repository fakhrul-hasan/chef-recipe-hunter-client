...
const Blog = () => {
  return (
    <div className="bg-white w-5/6 mx-auto p-4 mt-3">
      ...
      <div className="flex gap-4 px-2 mb-4">
        ...
        <p>
          ...
          controlled component is handled by the component rather than the DOM.
          It takes its current value through props. The changes are notified
          through callbacks.
        </p>
        <p>
      ...
      <div className="gap-4 px-2 mb-4">
        <p>
          ...
          verify the input type for props in react. If you try to put any other
          type, then it will give you warning in console. In react, there are
          some validators are available like propTypes.any, propTypes.array,
          propTypes.bool etc. With React props, you can send data to a component
          when you call on that component, including numbers, strings,
          functions, objects, and arrays. If you have multiple components, you
      ...
      <div className="gap-4 px-2 mb-4">
        <div className="flex px-2">
          <span className="font-bold text-lg">Ans:</span>
          <table className='border border-black ms-4'>
            <tr>
            ...
            <tr>
              ...
              <td className='border border-black'>More coding time as compared to Express</td>
              <td className='border border-black'>Very less coding time</td>
            </tr>
            <tr>
              <td className='border border-black'>Building block</td>
              <td className='border border-black'>Its built on Google V8 Engine</td>
              <td className='border border-black'>Built on Node.js</td>
            </tr>
            <tr>
              <td className='border border-black'>Requirement</td>
              <td className='border border-black'>Express is not required for Node</td>
              <td className='border border-black'>Node is essential to run Express</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className='border border-black'>Controllers are not provided</td>
              <td className='border border-black'>Controllers are provided</td>
            </tr>
            <tr>
      ...
      <div className="gap-4 px-2">
        <p>
          <span className="font-bold text-lg">Ans:</span> Custom Hook is a JavaScript function which we create by ourselves, when we want to share logic between other JavaScript functions. It allows you to reuse some piece of code in several parts of your app.
        </p>
      </div>
    </div>
  );
